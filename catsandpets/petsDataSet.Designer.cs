...
namespace catsandpets {
    ...
    public partial class petsDataSet : global::System.Data.DataSet {
        ...
        public partial class PetDataTable : global::System.Data.TypedTableBase<PetRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PetRow AddPetRow(string PetTypeName, PetTypeRow parentPetTypeRowByTypeIdFK) {
        ...
        public partial class PetRow : global::System.Data.DataRow {
            ...
            public string PetTypeName {
                get {
                    return ((string)(this[this.tablePet.PetTypeNameColumn]));
                }
                set {
                    this[this.tablePet.PetTypeNameColumn] = value;
                }
            }
...
namespace catsandpets.petsDataSetTableAdapters {
    ...
    public partial class PetTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Pet] WHERE (([Id] = @Original_Id) AND ([PetTypeName] = @Origin" +
                "al_PetTypeName) AND ([TypeId] = @Original_TypeId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Pet] ([PetTypeName], [TypeId]) VALUES (@PetTypeName, @TypeId);" +
                "\r\nSELECT Id, PetTypeName, TypeId FROM Pet WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Pet] SET [PetTypeName] = @PetTypeName, [TypeId] = @TypeId WHERE (([" +
                "Id] = @Original_Id) AND ([PetTypeName] = @Original_PetTypeName) AND ([TypeId] = " +
                "@Original_TypeId));\r\nSELECT Id, PetTypeName, TypeId FROM Pet WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::catsandpets.Properties.Settings.Default.petsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, PetTypeName, TypeId FROM dbo.Pet";
        ...
        public virtual int Delete(int Original_Id, string Original_PetTypeName, int Original_TypeId) {
        ...
        public virtual int Insert(string PetTypeName, int TypeId) {
            if ((PetTypeName == null)) {
        ...
        public virtual int Update(string PetTypeName, int TypeId, int Original_Id, string Original_PetTypeName, int Original_TypeId, int Id) {
            if ((PetTypeName == null)) {
                throw new global::System.ArgumentNullException("PetTypeName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string PetTypeName, int TypeId, int Original_Id, string Original_PetTypeName, int Original_TypeId) {
            return this.Update(PetTypeName, TypeId, Original_Id, Original_PetTypeName, Original_TypeId, Original_Id);
        }
    }
